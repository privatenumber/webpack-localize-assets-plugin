...
describe('error-cases', () => {
	...
	test('warn on confusing function usage', async () => {
		...
		expect(built.stats.compilation.warnings[0].message).toMatch('Ignoring confusing usage of localization function "__" in /src/index.js:3:6');
		expect(built.stats.compilation.warnings[1].message).toMatch('Ignoring confusing usage of localization function "__" in /src/index.js:4:6');
	});
